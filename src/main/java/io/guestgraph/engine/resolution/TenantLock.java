...
/**
 * Serializes all graph mutations within a tenant (Constitution IV, FR-011) via a transaction-scoped
 * Postgres advisory lock — released automatically on commit/rollback. Tenants never block each
 * other (research R3).
 */
@Component
