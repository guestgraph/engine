package io.guestgraph.engine.normalize;

import io.guestgraph.engine.api.Sha256;

/**
 * ID documents are stored hash-only (constitution: data minimization). Hash input is normalized as
 * TYPE:NUMBER — type uppercased/trimmed, number uppercased with all whitespace removed.
 */
